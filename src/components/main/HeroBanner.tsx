export default function HeroBanner() {
  return (
    <div className="relative w-full h-80 rounded-xl overflow-hidden mb-8 shadow-2xl">
      ...
      <div className="relative z-20 h-full p-8 flex flex-col justify-center max-w-2xl">
